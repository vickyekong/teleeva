...
export default function DoctorGate({
  children,
}: {
  ...
  if (profile.role !== "doctor") {
    return (
      <div className="mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <h2 className="mt-4 text-xl font-semibold text-slate-900">Doctor access only</h2>
        <p className="mt-2 text-slate-600">
          This dashboard is for doctors. Use the provider portal to open your role workspace.
        </p>
        <Link
